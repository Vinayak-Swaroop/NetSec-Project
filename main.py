...
class MainApplication:
    def __init__(self, app, key):
        self.app = app
        self.app.geometry('%sx%s' % (int(self.app.winfo_screenwidth()/3), int(app.winfo_screenheight()/2)))
        ...
        self.app.title("Image "+self.encrypt_text.get()+"  Chaos System")
...
class LoginApp:
    def __init__(self, app):
        ...
        self.login_button = tk.Button(self.frame, text="Login", font=('Helvetica', 10), command=lambda:self.start_intro(self.login_entry.get()))
        self.generate_button = tk.Button(self.frame, text="Generate new key pairs", font=('Helvetica', 10), command=self.generateKeyPairs)
